defmodule Binance.API.Wallet.Capital do
  ...
  @spec all_coins_information_v1(Binance.Client.t(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  ...
  @spec deposit_address_v1(Binance.Client.t(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  Deposit Address
  Variant: User Data
  ...
  @spec fetch_deposit_address_list_with_network_v1(Binance.Client.t(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  ...
  @spec one_click_arrival_deposit_apply_v1(Binance.Client.t(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            subAccountId: Keyword.get(opts, :subAccountId),
            subUserId: Keyword.get(opts, :subUserId),
            timestamp: nil
          ],
          headers: [{"X-MBX-APIKEY", ""}, {"Accept", "application/json"}],
          body: %{mode: "urlencoded", urlencoded: []}
  ...
  @spec withdraw_v1(Binance.Client.t(), term(), term(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  Withdraw
  Variant: User Data
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            offset: Keyword.get(opts, :offset),
            limit: Keyword.get(opts, :limit),
            idList: Keyword.get(opts, :idList),
            startTime: Keyword.get(opts, :startTime),
            endTime: Keyword.get(opts, :endTime),
            recvWindow: Keyword.get(opts, :recvWindow),
            timestamp: nil
