defmodule Binance.API.VipLoan.MarketData do
  ...
  @spec query_vip_loan_fixed_rate_market_v1(Binance.Client.t(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  Query VIP Loan Fixed Rate Market
  Variant: User Data
  Tags: user_data
  Method: GET
  ...
  Requires signature: true
  Required: loanCoin
  Optional: duration, current, size, recvWindow
  """
  def query_vip_loan_fixed_rate_market_v1(client, loanCoin, opts \\ []) do
    with {:ok, base_url} <- base_url(client.env) do
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          client: client,
          ...
          method: "GET",
          base_url: base_url,
          url: "/sapi/v1/loan/vip/fixed/market",
          query: [
            loanCoin: loanCoin,
