defmodule Binance.API.Spot.Trade do
  ...
  @spec cancel_all_open_orders_on_a_symbol_v3(Binance.Client.t(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  ...
  @spec cancel_order_v3(Binance.Client.t(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  Cancel order
  Method: DELETE
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            cancelRestrictions: Keyword.get(opts, :cancelRestrictions),
  ...
  @spec new_order_v3(Binance.Client.t(), term(), term(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  New order
  Method: POST
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            trailingDelta: Keyword.get(opts, :trailingDelta),
            ...
            pegPriceType: Keyword.get(opts, :pegPriceType),
            pegOffsetValue: Keyword.get(opts, :pegOffsetValue),
            pegOffsetType: Keyword.get(opts, :pegOffsetType),
            recvWindow: Keyword.get(opts, :recvWindow),
            timestamp: nil
          ],
          headers: [{"X-MBX-APIKEY", ""}, {"Accept", "application/json"}],
  ...
  @spec order_amend_keep_priority_v3(Binance.Client.t(), term(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  ...
  @spec cancel_an_existing_order_and_send_a_new_order_v3(
          Binance.Client.t(),
          term(),
          term(),
          term(),
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            quoteOrderQty: Keyword.get(opts, :quoteOrderQty),
            price: Keyword.get(opts, :price),
            cancelNewClientOrderId: Keyword.get(opts, :cancelNewClientOrderId),
            cancelOrigClientOrderId: Keyword.get(opts, :cancelOrigClientOrderId),
            cancelOrderId: Keyword.get(opts, :cancelOrderId),
            newClientOrderId: Keyword.get(opts, :newClientOrderId),
            strategyId: Keyword.get(opts, :strategyId),
            strategyType: Keyword.get(opts, :strategyType),
            stopPrice: Keyword.get(opts, :stopPrice),
            ...
            selfTradePreventionMode: Keyword.get(opts, :selfTradePreventionMode),
            cancelRestrictions: Keyword.get(opts, :cancelRestrictions),
            orderRateLimitExceededMode: Keyword.get(opts, :orderRateLimitExceededMode),
            pegPriceType: Keyword.get(opts, :pegPriceType),
            pegOffsetValue: Keyword.get(opts, :pegOffsetValue),
            pegOffsetType: Keyword.get(opts, :pegOffsetType),
            recvWindow: Keyword.get(opts, :recvWindow),
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            price: price,
            limitStrategyId: Keyword.get(opts, :limitStrategyId),
            limitStrategyType: Keyword.get(opts, :limitStrategyType),
            limitIcebergQty: Keyword.get(opts, :limitIcebergQty),
            trailingDelta: Keyword.get(opts, :trailingDelta),
            stopClientOrderId: Keyword.get(opts, :stopClientOrderId),
            stopPrice: stopPrice,
            stopStrategyId: Keyword.get(opts, :stopStrategyId),
            stopStrategyType: Keyword.get(opts, :stopStrategyType),
  ...
  @spec test_new_order_v3(Binance.Client.t(), term(), term(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  Test new order
  Method: POST
    ...
    with {:ok, base_url} <- base_url(client.env) do
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            computeCommissionRates: Keyword.get(opts, :computeCommissionRates),
            symbol: symbol,
            side: side,
            type: type,
            timeInForce: Keyword.get(opts, :timeInForce),
  ...
  @spec cancel_order_list_v3(Binance.Client.t(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  Cancel Order list
  Method: DELETE
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            quantity: quantity,
            aboveType: aboveType,
            aboveClientOrderId: Keyword.get(opts, :aboveClientOrderId),
            aboveIcebergQty: Keyword.get(opts, :aboveIcebergQty),
            abovePrice: Keyword.get(opts, :abovePrice),
            aboveStopPrice: Keyword.get(opts, :aboveStopPrice),
            aboveTrailingDelta: Keyword.get(opts, :aboveTrailingDelta),
            aboveTimeInForce: Keyword.get(opts, :aboveTimeInForce),
            aboveStrategyId: Keyword.get(opts, :aboveStrategyId),
            aboveStrategyType: Keyword.get(opts, :aboveStrategyType),
            abovePegPriceType: Keyword.get(opts, :abovePegPriceType),
            abovePegOffsetType: Keyword.get(opts, :abovePegOffsetType),
            abovePegOffsetValue: Keyword.get(opts, :abovePegOffsetValue),
            belowType: belowType,
            belowClientOrderId: Keyword.get(opts, :belowClientOrderId),
            belowIcebergQty: Keyword.get(opts, :belowIcebergQty),
            belowPrice: Keyword.get(opts, :belowPrice),
            belowStopPrice: Keyword.get(opts, :belowStopPrice),
            belowTrailingDelta: Keyword.get(opts, :belowTrailingDelta),
            belowTimeInForce: Keyword.get(opts, :belowTimeInForce),
            belowStrategyId: Keyword.get(opts, :belowStrategyId),
            belowStrategyType: Keyword.get(opts, :belowStrategyType),
            belowPegPriceType: Keyword.get(opts, :belowPegPriceType),
            belowPegOffsetType: Keyword.get(opts, :belowPegOffsetType),
            belowPegOffsetValue: Keyword.get(opts, :belowPegOffsetValue),
            newOrderRespType: Keyword.get(opts, :newOrderRespType),
            selfTradePreventionMode: Keyword.get(opts, :selfTradePreventionMode),
            recvWindow: Keyword.get(opts, :recvWindow),
            timestamp: nil
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            workingStrategyId: Keyword.get(opts, :workingStrategyId),
            workingStrategyType: Keyword.get(opts, :workingStrategyType),
            workingPegPriceType: Keyword.get(opts, :workingPegPriceType),
            workingPegOffsetType: Keyword.get(opts, :workingPegOffsetType),
            workingPegOffsetValue: Keyword.get(opts, :workingPegOffsetValue),
            ...
            pendingStrategyId: Keyword.get(opts, :pendingStrategyId),
            pendingStrategyType: Keyword.get(opts, :pendingStrategyType),
            pendingPegPriceType: Keyword.get(opts, :pendingPegPriceType),
            pendingPegOffsetType: Keyword.get(opts, :pendingPegOffsetType),
            pendingPegOffsetValue: Keyword.get(opts, :pendingPegOffsetValue),
            recvWindow: Keyword.get(opts, :recvWindow),
            timestamp: nil
          ],
          headers: [{"X-MBX-APIKEY", ""}, {"Accept", "application/json"}],
      ...
      {:ok, request} =
        Binance.RequestBuilder.build(%{
          ...
          query: [
            ...
            pendingAboveStrategyId: Keyword.get(opts, :pendingAboveStrategyId),
            pendingAboveStrategyType: Keyword.get(opts, :pendingAboveStrategyType),
            pendingAbovePegPriceType: Keyword.get(opts, :pendingAbovePegPriceType),
            pendingAbovePegOffsetType: Keyword.get(opts, :pendingAbovePegOffsetType),
            pendingAbovePegOffsetValue: Keyword.get(opts, :pendingAbovePegOffsetValue),
            ...
            pendingBelowStrategyId: Keyword.get(opts, :pendingBelowStrategyId),
            pendingBelowStrategyType: Keyword.get(opts, :pendingBelowStrategyType),
            pendingBelowPegPriceType: Keyword.get(opts, :pendingBelowPegPriceType),
            pendingBelowPegOffsetType: Keyword.get(opts, :pendingBelowPegOffsetType),
  ...
  @spec new_order_using_sor_v3(Binance.Client.t(), term(), term(), term(), term(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  New order using SOR
  Method: POST
  ...
  @spec test_new_order_using_sor_v3(
          Binance.Client.t(),
          term(),
          term(),
          term(),
