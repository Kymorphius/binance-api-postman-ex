defmodule Binance.API.DerivativesTrading.CoinFutures.Account do
  ...
  @spec futures_account_balance_v1(Binance.Client.t(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  ...
  @spec notional_bracket_for_pair_v1(Binance.Client.t(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
  ...
  @spec notional_bracket_for_symbol_v2(Binance.Client.t(), Keyword.t()) ::
          {:ok, term()} | {:error, term()}
  @doc """
